...
public class Map2Fragment extends Fragment {
    ...
    private static Map2Fragment instance;
    /**
     * Returns a new instance of this fragment for the given section
     * number.
     */
    public static Map2Fragment getInstance(int sectionNumber) {
        if (instance==null) {
            instance = new Map2Fragment();
    ...
    private void setUpMapIfNeeded() {
        ...
        if (mMap == null) {
            ...
            Fragment fragment = supportMapFragment.findFragmentById(R.id.map2);
